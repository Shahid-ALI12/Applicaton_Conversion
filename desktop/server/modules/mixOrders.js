...
mixOrdersRouter.get('/', requireAuth, (req, res) => {
    ...
    const total = db.prepare(`SELECT COUNT(*) as c FROM mix_orders m JOIN customers c ON c.id=m.customer_id WHERE ${where}`).get(...params).c;
...
//# sourceMappingURL=mixOrders.js.map